    ...
    await fetch('https://api.brevo.com/v3/contacts', {
      ...
      body: JSON.stringify({
        ...
        attributes: {
          URL_ANALYSEE:       url                        || '',
          SCORE:              String(score               || ''),
          SCORE_TUNNEL:       String(sc.tunnel           || ''),
          SCORE_OFFRE:        String(sc.offre            || ''),
          SCORE_CONFIANCE:    String(sc.confiance        || ''),
          SCORE_BRANDING:     String(sc.branding         || ''),
          SCORE_ARCHITECTURE: String(sc.architecture     || ''),
